...
/**
 * A port of the BGFX backend for ImGUI:
 * <a href="https://github.com/bkaradzic/bgfx/tree/master/examples/common/imgui">https://github.com/bkaradzic/bgfx/tree/master/examples/common/imgui</a>
 */
public class ImGuiImplBGFX {
    ...
    private void createShaders(int rendererType) {
        ...
        switch (rendererType) {
            ...
            default -> throw new IllegalStateException("Unexpected value: " + rendererType);
        }
